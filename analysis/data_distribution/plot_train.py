...
# Load TRAIN labels
# ======================
labels = np.load(".../TFBindFormer/data/dna_data/train/train_labels.npy")
...
fig.text(
    0.5, 0.93,
    "Distribution of Positive Bin Count per TF (training)",
    ha="center",
    va="center",
    fontsize=15,
    fontweight="bold"
...
# Save
# ======================
plt.savefig("train_violin.png", dpi=400)
plt.show()

print("Saved: train_violin.png")

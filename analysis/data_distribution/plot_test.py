...
# Load TEST labels
# ======================
labels = np.load(".../TFBindFormer/data/dna_data/test/test_labels.npy")
...
fig.text(
    0.5, 0.93,
    "Distribution of Positive Bin Count per TF (test)",
    ha="center",
    va="center",
    fontsize=15,
    fontweight="bold"
...
# Save
# ======================
plt.savefig("test_violin.png", dpi=400)
plt.show()

print("Saved: test_violin.png")